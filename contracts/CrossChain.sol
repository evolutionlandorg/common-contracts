...
contract CrossChain is DSAuth {
    ...
    // event
    event RingCrossChainEvent(address indexed token, address indexed owner, uint amount, bytes data);

    event KtonCrossChainEvent(address indexed token, address indexed owner, uint amount, bytes data);

    event TokenCrossChainEvent(address indexed token, address indexed owner, uint amount, bytes data);
    ...
    */
    function tokenFallback(address _from, uint256 _amount, bytes _data) public isWork{
        ...
        address txfee = registry.addressOf(0x434f4e54524143545f43524f5353434841494e5f545846454553000000000000);
        ...
        address kryptonite = registry.addressOf(0x434f4e54524143545f4b544f4e5f45524332305f544f4b454e00000000000000);
        ...
        txfeeContract.payTxFees(msg.sender, _from, _amount);
